    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[420px] overflow-hidden rounded-[18px] bg-[var(--raised)] p-0" finalFocus={returnFocus}>
        ...
        <div className="flex h-12 items-center gap-2.5 px-4 text-[14px]">
          <MackIcon className="size-[15px]" name="gitBranch" />
        ...
        <div className="px-2">
          ...
          >
            <span className={cn(
              ...
              {includeUnstaged && <MackIcon className="size-3" name="check" />}
            </span>
...
function CommitActionRow({
  ...
  return (
    <button
      ...
      onClick={onClick}
    >
      <MackIcon className={cn('size-3.5 text-[var(--text-secondary)]', pending && 'motion-safe:animate-spin')} name={pending ? 'loaderCircle' : icon} />
