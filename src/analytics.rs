...
const ENDPOINT: Option<&str> = option_env!("MACK_ANALYTICS_ENDPOINT");
#[cfg(debug_assertions)]
const ENDPOINT: Option<&str> = None;

#[cfg(not(debug_assertions))]
const WEBSITE_ID: Option<&str> = option_env!("MACK_ANALYTICS_WEBSITE_ID");
#[cfg(debug_assertions)]
