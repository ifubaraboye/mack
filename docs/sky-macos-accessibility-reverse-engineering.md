...
This is the critical path for Mack parity.
...
## Why Mack's previous approximation failed
...
## Compatibility requirements for Mack
...
1. Codex/Mack remains the actual frontmost application throughout.
